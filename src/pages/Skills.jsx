...
const ROWS = [
  [
    ...
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React", "Node.js", "Express.js"] },
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git", "GitHub"] },
   { title: "DevOps & Cloud", items: ["Docker", "AWS", "Linux"] },
  ],
  [
    {
      title: "Core Concepts",
