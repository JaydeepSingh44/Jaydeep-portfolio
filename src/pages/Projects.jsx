...
const PROJECTS = [
  {
    ...
    desc: 'Fast, reliable food delivery platform with real-time tracking and secure APIs, seamless ordering experience.',
    ss: '/Food1.png',
    tech: ['React+Vite', 'Node.js', 'Express', 'MongoDB'],
    live: 'https://quickbite-8e31.onrender.com',
    code: 'https://github.com/JaydeepSingh44/QuickBite'
  },
  {
  title: 'Job Portel',
...
export default function Projects() {
  return (
    <motion.section
      ...
      id="projects"
    >
      <div className="card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 16, padding: 8 }}>
        <motion.h2
